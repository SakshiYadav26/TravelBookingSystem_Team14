        ...
        <div className={styles.col}>
          ...
          <div className={styles.tabs}>
            <div className={styles.tab}>
              ...
              <label className={styles['tab-label']} htmlFor="chck1">How can I book a multi-sector itinerary?</label>
            ...
            <div className={styles.tab}>
              ...
              <label className={styles['tab-label']} htmlFor="chck2">How do I know that my booking is confirmed?</label>
              <div className={styles['tab-content']}>
            ...
            <div className={styles.tab}>
              ...
              <label className={styles['tab-label']} htmlFor="chck3"> Why do I have to book my onward and 
            ...
            <div className={styles.tab}>
              ...
              <label className={styles['tab-label']} htmlFor="chck4">How do I cancel or change my flight 
              reservation?</label>
              <div className={styles['tab-content']}>
            ...
            <div className={styles.tab}>
              ...
              <label className={styles['tab-label']} htmlFor="chck5">Can I change my hotel booking?</label>
              <div className={styles['tab-content']}>
            ...
            <div className={styles.tab}>
              ...
              <label className={styles['tab-label']} htmlFor="chck6">What are the terms and conditions that 
